...
import { bookingsStyles as styles } from "@/screens/bookingsStyles";
...
export default function Bookings() {
  ...
  const renderStatusActions = (item: Booking) => {
      ...
      return (
        <View style={styles.actionRow}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() => Alert.alert("Accept Job", "This job will be marked as Accepted.")}
          >
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() => Alert.alert("Decline Job", "This job will be declined.")}
          >
      ...
      return (
        <View style={styles.actionRow}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() => Alert.alert("Cancel Job", "This job will be cancelled.")}
          >
    ...
    if (
      mainTab === "booked" &&
      (item.status === "Upcoming" || item.status === "Accepted" || item.status === "Ongoing")
    ) {
      return (
        <View style={styles.actionRow}>
          <TouchableOpacity
            style={[styles.actionButton, styles.cancelButton]}
            activeOpacity={0.8}
            onPress={() => Alert.alert("Cancel Booking", "This booking will be cancelled.")}
          >
            <Ionicons name="close-circle-outline" size={16} color="#DC2626" />
            <Text style={styles.cancelButtonText}>Cancel</Text>
          </TouchableOpacity>
      ...
      return (
        <View style={styles.actionRow}>
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() =>
              Alert.alert("Approve Job", "Job approved. Payment will be released to the professional.")
            }
          >
            <Ionicons name="checkmark" size={16} color="#FFFFFF" />
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.mainTabsContainer}>
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={[styles.mainTabText, mainTab === "booked" && styles.activeMainTabText]}>
            My Bookings
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={[styles.mainTabText, mainTab === "received" && styles.activeMainTabText]}>
            Received Jobs
          </Text>
        </TouchableOpacity>
      </View>
              ...
              >
                ...
                <View style={styles.photoRow}>
                  {reportPhotos.map((uri, index) => (
                    <View key={uri}>
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => setReportPhotos((prev) => prev.filter((_, i) => i !== index))}
                      >
                  ...
                  {reportPhotos.length < 3 && (
                    <TouchableOpacity style={styles.addPhotoBtn} onPress={pickReportPhotos} activeOpacity={0.8}>
