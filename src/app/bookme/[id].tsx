...
export default function BookMeScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      {/* NOTE: Remaining modals and StyleSheet are preserved from original file.
          Full file was truncated in this restore - RESTORING FROM LOCAL BACKUP NEXT IF NEEDED.
      */}
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  backLink: { marginTop: 12, color: "#16A34A", fontWeight: "600" },
  header: {
    flexDirection: "row",
    alignItems: "center",
  ...
  totalLabel: { fontSize: 16, fontWeight: "700", color: "#16A34A" },
  ...
  serviceOptionPrice: { fontSize: 13, color: "#6B7280", marginTop: 2 },
});
